	...
	lazy_static! {
		static ref SPEC: Vec<(Category, Regex)> =
			vec![
				...
				(Category::Binary(0), Regex::new(r"^\:").unwrap()),
				(Category::Binary(1), Regex::new(r"^\|").unwrap()),
				(Category::Binary(2), Regex::new(r"^\&").unwrap()),
				(Category::Binary(3), Regex::new(r"^((==)|(=)|(!=))").unwrap()),
				(Category::Binary(4), Regex::new(r"^((>=)|(<=)|(>)|(<))").unwrap()),
				(Category::Binary(5), Regex::new(r"^((-)|(\+))").unwrap()),
				(Category::Binary(6), Regex::new(r"^((/)|(\*))").unwrap()),
				(Category::Binary(7), Regex::new(r"^(\^)").unwrap()),
